...
class SwigDirector_CThostFtdcTraderSpi : public CThostFtdcTraderSpi
{
 public:
  ...
  void _swig_upcall_OnRspLockInsert(CThostFtdcInputLockField *pInputLock, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    CThostFtdcTraderSpi::OnRspLockInsert(pInputLock,pRspInfo,nRequestID,bIsLast);
  }
  ...
  void _swig_upcall_OnRspQryLock(CThostFtdcLockField *pLock, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    CThostFtdcTraderSpi::OnRspQryLock(pLock,pRspInfo,nRequestID,bIsLast);
  }
  virtual void OnRspQryLock(CThostFtdcLockField *pLock, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
  void _swig_upcall_OnRspQryLockPosition(CThostFtdcLockPositionField *pLockPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    CThostFtdcTraderSpi::OnRspQryLockPosition(pLockPosition,pRspInfo,nRequestID,bIsLast);
  }
  ...
  void _swig_upcall_OnRspQryInvestorLevel(CThostFtdcInvestorLevelField *pInvestorLevel, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    CThostFtdcTraderSpi::OnRspQryInvestorLevel(pInvestorLevel,pRspInfo,nRequestID,bIsLast);
  }
  ...
  void _swig_upcall_OnRspQryExecFreeze(CThostFtdcExecFreezeField *pExecFreeze, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    CThostFtdcTraderSpi::OnRspQryExecFreeze(pExecFreeze,pRspInfo,nRequestID,bIsLast);
  }
  ...
  void _swig_upcall_OnRtnLock(CThostFtdcLockField *pLock) {
    CThostFtdcTraderSpi::OnRtnLock(pLock);
  }
  virtual void OnRtnLock(CThostFtdcLockField *pLock);
  void _swig_upcall_OnErrRtnLockInsert(CThostFtdcInputLockField *pInputLock, CThostFtdcRspInfoField *pRspInfo) {
    CThostFtdcTraderSpi::OnErrRtnLockInsert(pInputLock,pRspInfo);
  }
